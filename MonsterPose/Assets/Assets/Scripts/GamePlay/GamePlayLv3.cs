...
public class GamePlayLv3 : MonoBehaviour
{
    ...
    {
        handTap.transform.DOMoveX(transform.position.x, 1f)
            .OnComplete(() =>
            {
                handTap.transform.position = startHand.position;
                MoveTap();
            });
    }
